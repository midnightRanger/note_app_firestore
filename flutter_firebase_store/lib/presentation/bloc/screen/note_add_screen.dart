...
class _NoteAddStatePage extends State<NoteAddPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: BlocProvider(
          create: (context) =>
              NoteAddPageCubit(NoteAddState(initial: true)),
                ...
                child: Align(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(
                          onPressed: () => context.read<NoteAddPageCubit>().addNote(Note(category: categoryController.text, status: true, lastUpdating: DateTime.now().toString(), creationDate: DateTime.now().toString(), content: contentController.text,
                           name: nameController.text, authorId: "")),
