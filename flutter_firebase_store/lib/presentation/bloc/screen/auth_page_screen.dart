...
import 'package:flutter_firebase_store/domain/utils/enum_extensions.dart';
...
class _AuthStatePage extends State<AuthPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AuthPageCubit(AuthUserState.initial),
...
class _AuthWidgetStatePage extends State<AuthPageWidget> {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<AuthPageCubit, AuthUserState>(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () {
                                if (registerAuthMode) {
                                  context.read<AuthPageCubit>().registerUser(
                                      new User(
                                  ...
                                  context.read<AuthPageCubit>().loginUser(
                                      new User(
                                          email: _emailController.text,
                                          userName: _usernameController.text,
                                          password: _passwordController.text,
                              ...
                              child: Text(
                                  registerAuthMode ? 'Register' : 'Sign In'),
                              style: ButtonStyle(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: Text(
                                  registerAuthMode ? "Sign In" : "Regsiter"),
                            )
                          ],
                        ),
                      ],
